//////////////////////////////////////////////////////////////////////////////////////////
/*
  Receives one byte of serial data from p5_Serial_Servo sketch, to control angle of servo motor. 
  Pair with "p5_Serial_Servo" sketch.
*/
//////////////////////////////////////////////////////////////////////////////////////////
...
void setup() 
{
  ...
  Serial.begin(9600);    // Start serial communication at 115200 bps
}
